...
export default function NavDrawer({ usersData, setFilteredUsers }) {
  ...
  return (
    <div className="">
      ...
      <aside
        className={`absolute top-0 left-0 z-10 w-full max-w-[250px] text-gray-500 bg-white p-5 pt-3 text-xs md:text-sm transform h-screen xl:translate-x-0 transition-all ${navOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
